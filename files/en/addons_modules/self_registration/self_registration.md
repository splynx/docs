...
* Create App and specify its name, app contact email, app purpose etc. Pay particular attention to complete the security check (Google reCaptcha).
    ![13.png](13.png)
    ![13.1.png](13.1.png)
...
* In **App details** you can specify app description and its icon. Also, it's necessary to change **App permissions** to _read and write_.
![19.1.png](19.1.png)
